...
/**
 ...
 Usage:
 ```
 extension YourViewController: PanViewPresentable {
 func shouldRoundTopCorners: Bool { return false }
 }
 ```
 */
public protocol PanViewPresentable: AnyObject {
   ...
   */
  var shortFormHeight: PanView.Height { get }
   ...
   */
  var longFormHeight: PanView.Height { get }
